...
public class Clouds {
	...
	public static void draw(Graphics2D g2D) {
		...
		g2D.fillOval((int) 800, (int) 15, (int) ScreenWidth / 10, (int) ScreenWidth / 10);
		...
		g2D.fillOval((int) 700, (int) 20, (int) ScreenWidth / 12, (int) ScreenHeight / 12);
		g2D.fillOval((int) 700, (int) 85, (int) ScreenWidth / 12, (int) ScreenHeight / 12);
		g2D.fillOval((int) 800, (int) 60, (int) ScreenWidth / 12, (int) ScreenHeight / 12);

		g2D.setColor(cloudColor); // Right cloud
		g2D.fillOval((int) 1300, (int) 30, ScreenWidth / 20, ScreenHeight / 20);
		g2D.fillOval((int) 1350, (int) 10, (int) ScreenWidth / 20, ScreenHeight / 20);
		g2D.fillOval((int) 1350, (int) 50, ScreenWidth / 20, ScreenHeight / 20);
		g2D.fillOval((int) 1400, (int) 30, (int) ScreenWidth / 20, ScreenHeight / 20);
